    ...
    <>
      <Container>
        ...
        <Typography variant="h5" gutterBottom>
          <i>How does </i><span id='brand'>movie-aja</span> <i>work?</i>
        </Typography>
        ...
        <div id='instructionContainer'>
          ...
          <Grid container spacing={7}>
            <Grid item xs={12} sm={6}>
              ...
              <ol>
                <li>Username</li>
                <li>Hit <Button id='createCallBtn' variant='outlined'>Create room</Button></li>
                <li>Allow Microphone and Camera access via your browser (they can be turned off during the call)</li>
              </ol>
            </Grid>
            <Grid item xs={12} sm={6}>
              <Typography variant="h5" gutterBottom>
          ...
          <Grid container spacing={7}>
            <Grid item xs={12} sm={6}>
              <ol>
                <li>Make sure you are using Google Chrome or a Chromium-based browser</li>
