      ...
      <div id='joinContainer'>
        <div id='inputContainer'>
          ...
          <Typography variant="h5" gutterBottom>
            <i>Free Hoke  </i><br></br><span id='brand'>movie-aja</span>
          </Typography>
          <br />
          ...
          <br />
          <a rel='noreferrer' target='_blank' href={ROUTES.BUY_ME_TEA}>My Linkdn</a>
          <a rel='noreferrer' target='_blank' href={ROUTES.PATREON}>Checkout my pins</a>
